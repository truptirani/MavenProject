...
public class xlsxReader {
	...
	// public static String filename =
	// System.getProperty("user.dir")+"\\src\\SPReddy.xlsx";
	public String path;
	...
	public boolean removeColumn(String sheetName, int colNum) {
		try {
			...
			XSSFCellStyle style = workbook.createCellStyle();
			style.setFillForegroundColor(HSSFColor.GREY_40_PERCENT.index);
			setCreateHelper(workbook.getCreationHelper());
	...
	public static void main(String arg[]) throws IOException {
		xlsxReader xl = new xlsxReader("d:\\empdetails.xlsx");

		// datatable.getRowCount("Sheet1");
		System.out.println("Row count=" + xl.getRowCount("Sheet1"));
		for (int i = 1; i <= xl.getRowCount("Sheet1"); i++) {
			for (int j = 0; j < xl.getColumnCount("Sheet1"); j++) {
				// System.out.println(xl.getCellData("Sheet1",j,i));
				String expected = xl.getCellData("Sheet1", j, i);
